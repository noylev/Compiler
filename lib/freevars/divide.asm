...
L_Div_Body:
	...
	CMP(FPARG(1),IMM(2));
	JUMP_LT(L_Div_Body_fewer_then_2);
...
L_Div_Body_loop:          
	...
	MOV(R6,INDD(R0,2));
	INCR(R1);
	JUMP(L_Div_Body_loop);   
L_Div_Body_loop_exit:
...
L_Div_Body_fewer_then_2:
        CMP(FPARG(1),IMM(1));
        JUMP_LT(L_Div_Zero_Item);
...
L_Div_Clos:
    ...
    MOV(INDD(R0,3),LABEL(L_Div_Body));
