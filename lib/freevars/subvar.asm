...
L_Sub_Body:
	...
	CMP(FPARG(1),IMM(2));
	JUMP_LT(L_Sub_Body_fewer_then_2);
...
L_Sub_Body_loop:          
	...
	MOV(R6,INDD(R0,2));
	INCR(R1);
	JUMP(L_Sub_Body_loop);   
L_Sub_Body_loop_exit:
...
L_Sub_Body_fewer_then_2:
        CMP(FPARG(1),IMM(1));
        JUMP_LT(L_Sub_Zero_Item);
...
L_Sub_Clos:
    ...
    MOV(INDD(R0,3),LABEL(L_Sub_Body));
